...
class PharmacyShopProduct extends StatefulWidget {
  PharmacyShopProduct(
  ...
  @override
  State<PharmacyShopProduct> createState() => _PharmacyShopProductState();
}

class _PharmacyShopProductState extends State<PharmacyShopProduct> {
  @override
  void initState() {
    super.initState();
